...
//
//     final covidcompletedata = covidcompletedataFromJson(jsonString);

import 'dart:convert';

Covidcompletedata covidcompletedataFromJson(String str) => Covidcompletedata.fromJson(json.decode(str));

String covidcompletedataToJson(Covidcompletedata data) => json.encode(data.toJson());

class Covidcompletedata {
  Covidcompletedata({
  ...
  factory Covidcompletedata.fromJson(Map<String, dynamic> json) => Covidcompletedata(
...
class CasesTimeSery {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "date": date,
    "dateymd": "${dateymd.year.toString().padLeft(4, '0')}-${dateymd.month.toString().padLeft(2, '0')}-${dateymd.day.toString().padLeft(2, '0')}",
...
class Tested {
  ...
  factory Tested.fromJson(Map<String, dynamic> json) => Tested(
    dailyrtpcrsamplescollectedicmrapplication: json["dailyrtpcrsamplescollectedicmrapplication"],
    firstdoseadministered: json["firstdoseadministered"],
    frontlineworkersvaccinated1Stdose: json["frontlineworkersvaccinated1stdose"],
    frontlineworkersvaccinated2Nddose: json["frontlineworkersvaccinated2nddose"],
    healthcareworkersvaccinated1Stdose: json["healthcareworkersvaccinated1stdose"],
    healthcareworkersvaccinated2Nddose: json["healthcareworkersvaccinated2nddose"],
    ...
    to60YearswithcoMorbidities1Stdose: json["to60yearswithco-morbidities1stdose"],
    to60YearswithcoMorbidities2Nddose: json["to60yearswithco-morbidities2nddose"],
    ...
    totalrtpcrsamplescollectedicmrapplication: json["totalrtpcrsamplescollectedicmrapplication"],
  ...
  Map<String, dynamic> toJson() => {
    "dailyrtpcrsamplescollectedicmrapplication": dailyrtpcrsamplescollectedicmrapplication,
    ...
    "healthcareworkersvaccinated1stdose": healthcareworkersvaccinated1Stdose,
    "healthcareworkersvaccinated2nddose": healthcareworkersvaccinated2Nddose,
    ...
    "totalrtpcrsamplescollectedicmrapplication": totalrtpcrsamplescollectedicmrapplication,
